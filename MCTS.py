...
class MCTS():
    ...
    def __init__(self, env, nnet, num_iter, cpuct):
        self.env = env
        self.nnet = nnet
        ...
        self.Es = {}  # stores env.getGameEnded ended for board s
        self.Vs = {}  # stores env.getValidMoves for board s

    def get_prob(self, state, temp=1):
        """
        This function performs num_iter simulations of MCTS starting from state.
        Returns:
